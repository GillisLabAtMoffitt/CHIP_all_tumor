...
```{r CH status}
CH_status <- CH_status %>%
  bind_rows(., colorectal_samples, mm_samples) %>%
...
```{r load rds}
# write_rds(data, "Rmd/R01 Gillis-Teng 2023-2024/cleaned_all_tumor_type_data_02262024.rds")
data <- read_rds(paste0(here::here(), "/Rmd/R01 Gillis-Teng 2023-2024/cleaned_all_tumor_type_data_02262024.rds"))
```
